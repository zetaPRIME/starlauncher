...
namespace starlight {
    namespace gfx {
        ...
        public:
            ...
            virtual void Draw(const Vector2& position, OptRef<Vector2> hotspot = nullptr, OptRef<VRect> sampleRect = nullptr, OptRef<Color> color = nullptr, float rotation = 0, const Vector2& scale = Vector2::one) = 0;
